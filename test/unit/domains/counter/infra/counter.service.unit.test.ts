...
import type {
  CounterService,
  GetCounterService,
} from '~/domains/counter/domain/counter-service'
import type { CounterServiceConfig } from '~/domains/counter/infra/counter.service'
    ...
    describe('counter', () => {
      describe('infra', () => {
        describe('counter service', () => {
          ...
          beforeAll(async () => {
            vi.doMock(
              '~/domains/counter/infra/firestore/firestore-counter.service',
              () => ({
            ...
            getCounterService = (
              await import('~/domains/counter/infra/counter.service')
            ).getCounterService
